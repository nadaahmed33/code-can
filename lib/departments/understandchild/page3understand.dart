...
//(٣) تعمل إيه لو بعتوك تشترى عيش أو حاجة ، والبقال قال لك أن العيش خلص أو الله ما عندوش الحاجة دى ؟
                  children: [
                    Row(
                      ...
                      children: [
                        Text(" تعمل إيه لو بعتوك ",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                        Text("(٣)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                      ],
                    ),

                    Center(
                      child: Text(" تشترى عيش أو حاجة ،",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    ),
                    Center(
                      child: Text("والبقال قال لك أن العيش",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    ),
                    Center(
                      child: Text(" خلص أو و الله ما عندوش",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    ),
                    Center(
                      child: Text("الحاجة دى"+"؟" ,style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    )
                  ],
                ),
                // Container(
