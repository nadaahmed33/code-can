...
import 'page7understand.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';
class Page6understandClass extends StatefulWidget{
  State<Page6understandClass>createState()=> _pg();
}
class _pg extends State<Page6understandClass> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text("ليه البيت المبنى من",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                        Text("(٦)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                      ],
                    ),
                    Center(
                      child: Text("الطوب أحسن من البيت",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    ),
                    Center(
                      child: Text("المبنى من الخشب"+"؟",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                    ),
                  ],
                ),
                // Container(
                ...
                GestureDetector(
                    onTap: ()async{
                      question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='u' AND id=6 ");
